...
function createFooter() {
    ...
    odinImg.classList.add('footer__odin-logo');
    ...
    const secondP = document.createElement('span');
    secondP.classList.add('footer__odin-text');
    ...
    divGroup2.classList.add('footer__right-group');

    const fourthP = document.createElement('span');
    fourthP.textContent = ' By Linas Paulauskas';

    const profileDiv = document.createElement('div');
    profileDiv.classList.add('footer__profile-group');
    ...
    profileImg.classList.add('footer__profile-logo');
